...
plans, everything! Nobody on the team can even seem to remember important details of the project!"

"Wouldn't they have had enough fabric to fill several boxes in the warehouse? 
They'd be stored together, so the box IDs should be similar. Too bad it would take 
forever to search the warehouse for two similar box IDs..." They walk too far away to hear any more.
...
for x in data:
	...
	big_dict = freq_count(x)

	if 2 in big_dict.values():
		count_twos += 1

	if 3 in big_dict.values():
		count_threes += 1


print("Two's: ", count_twos)
print("Three's: ", count_threes)

print(count_twos,' * ',count_threes,' = ',count_twos*count_threes)
